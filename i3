...
bindsym $mod+Return exec xterm -u8
...
bindsym $mod+Ctrl+t exec --no-startup-id compton -b bindsym $mod+Shift+d --release exec "killall dunst; exec notify-send 'restart dunst'"
...
exec_always feh --bg-scale /home/leorog/Pictures/wallpaper2.jpg
...
bar {
  ...
  font pango:monospace 8.5, FontAwesome 8.5
...
# -fn "System San Francisco Display" -l 5
...
exec setxkbmap -layout us,us -variant ,intl -model pc105 -option ctrl:nocaps,grp:alt_shift_toggle
